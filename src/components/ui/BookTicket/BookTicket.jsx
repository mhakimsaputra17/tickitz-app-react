...
function BookTicket() {
  return (
    <>
      <>
        {/* Booking section */}
        <main className="max-w-[1000px] mx-[auto] my-[0] bg-[white]">
          <section className="booking mx-5 mb-10">
            <h2 className="text-xl mb-6 font-semibold">Book Tickets</h2>
            {/* Booking filters */}
            <div className="booking-filters flex gap-3 mb-8 flex-wrap">
              ...
              <button className="filter-button px-16 py-4 bg-blue-500 text-white border-none rounded-md font-medium cursor-pointer self-end mt-auto">
                Filter
              </button>
            </div>
            {/* Cinema selection */}
            <div className="cinema-selection mb-8">
              ...
              <div className="cinema-grid flex flex-nowrap gap-[15px] mb-8">
                <div className="cinema-card basis-1/4 flex-grow min-w-[200px] h-[100px] border border-gray-200 rounded-md flex justify-center items-center p-3 bg-white">
                  <img
                ...
                <div
                  className="cinema-card basis-1/4 flex-grow min-w-[200px] h-[100px] border border-gray-200 rounded-md flex justify-center items-center p-3 bg-white"
