  ...
  return (
    <>
      <section className="w-full overflow-x-hidden">
        <div className="header-features px-[5%] py-[20px] md:py-[30px] lg:py-[40px] text-center md:text-start">
          ...
          <h2 className="text-[24px] md:text-[28px] lg:text-[32px] font-normal leading-[1.3] md:leading-[1.4] tracking-[0.8px] md:tracking-[1px] max-w-full md:max-w-[638px] mx-auto md:mx-0">
            Unleashing the Ultimate Movie Experience
          </h2>
        </div>
        <div className="features flex flex-col md:flex-row px-[5%] py-[10px] md:py-[15px] lg:py-[20px] gap-y-[15px] md:gap-y-[20px] md:gap-x-[20px] md:flex-wrap justify-center md:justify-start">
          <div className="feature flex-[1_1_100%] md:flex-[0_0_calc(50%-20px)] lg:flex-[0_0_calc(33.333%-20px)] max-w-full md:max-w-[400px] flex flex-col items-center text-center gap-[8px] md:gap-[10px] p-[15px] md:p-[20px]">
            ...
            <p className="text-[14px] md:text-[15px] lg:text-[16px] font-normal leading-[1.5] md:leading-[1.6] tracking-[0.5px] md:tracking-[0.75px] max-w-full md:max-w-[340px] text-center text-[#a0a3bd]">
